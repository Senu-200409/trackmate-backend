...
namespace TrackMateBackend.Controllers
{
    public class UserDetailsController : Controller
    {
        ...
        public ActionResult ProfileImagePreview(string UserID)
        {
            ...
            [HttpPost]
            public ActionResult SendOtp(UserDetailsRequestApi requestAPI)
            {
                var result = _userdetails.SendOtp(requestAPI);
                return Json(result, JsonRequestBehavior.AllowGet);
            }
...
//        [HttpGet]
//        public ActionResult GetAllUserDetails(UserDetailsRequestAPI requestAPI)
//        {
//            var result = _userDetails.GetAllUsers(requestAPI);
//            return Json(result, JsonRequestBehavior.AllowGet);
//        }
...
//        [HttpGet]
//        public ActionResult GetUserDetailsByUserID(UserDetailsRequestAPI requestAPI)
//        {
//            var result = _userDetails.GetUserById(requestAPI);
//            return Json(result, JsonRequestBehavior.AllowGet);
//        }

//        [HttpPost]
//        public ActionResult AddUserDetails(UserDetailsRequestAPI requestAPI)
//        {
//            var result = _userDetails.RegisterUser(requestAPI);
//            return Json(result, JsonRequestBehavior.AllowGet);
//        }
...
//        [HttpPost]
//        public ActionResult PutUserDetails(UserDetailsRequestAPI requestAPI)
//        {
//            var result = _userDetails.UpdateUser(requestAPI);
//            return Json(result, JsonRequestBehavior.AllowGet);
//        }
...
//        public ActionResult UpdateUserStatus(UserDetailsRequestAPI requestAPI)
//        {
//            var result = _userDetails.DeleteUser(requestAPI);
//            return Json(result, JsonRequestBehavior.AllowGet);
//        }
